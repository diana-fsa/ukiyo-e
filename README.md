...
Al fitxer `code-catalan` s'explora la base de dades i es crea un classificador d'imatges per arribar a una resposta.
...
In the file `code-english` there is first approximation of the data base and an image classifier is built to get to an answer.
